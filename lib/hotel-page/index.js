...
class HotelPage extends Component {
  ...
  render () {
    ...
    const hotelDescription = this.state.textVisible ? 'textVisible' : 'textHidden';
    const read = this.state.textVisible ? 'READ LESS' : 'READ MORE';
    const gradient = this.state.textVisible ? '' : 'gradientOut';
    return (
      <div>
        <NavHeader />
        ...
        <div className='infoContainer'>
          ...
          <div className='heartRatingContainer'>
            ...
            <div className='descriptionWrapper'>
              ...
              <div className='moreButton' onClick={() => this.setState({textVisible: !this.state.textVisible})}>{read}</div>
            </div>
