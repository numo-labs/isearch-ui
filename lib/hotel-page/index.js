...
class HotelPage extends Component {
  ...
  renderAmenities (amenities) {
    const amenitiesToRender = amenities.map((amenity, index) => {
      ...
      return (
          <div key={index}>{_.capitalize(amenity)}</div>
        );
    });
        ...
        <div className='factWrapper'>
          ...
          <div className='factContainer'>
            ...
            <div className='factValues'>
              ...
              {amenities.map((amenity) => {return (<div>Ja</div>)})}
            </div>
          </div>
        </div>
      </div>
  ...
  render () {
    ...
    const more = amenitiesTwo.length < 3 ? '' : '+ Mere';
        ...
        <div className='infoContainer'>
          ...
          <div className='titleHeartContainer'>
            ...
            <div className='descriptionWrapper'>
              ...
              {this.renderFactlist(amenitiesOne.concat(amenitiesTwo))}
