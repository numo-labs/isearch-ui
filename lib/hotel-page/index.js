...
import ISearchSlider from '../slider';
...
const tickImageSrc = 'https://cloud.githubusercontent.com/assets/12450298/14638007/012521c0-062d-11e6-9e7b-34aded598a3f.png';
const deepLink = 'http://spiesdk.acctest.int/?utm_source=inspriational_search';
// const hotelImages = [
...
class HotelPage extends Component {
    ...
    const amenitiesToRender = amenities.map((amenity, index) => {
      return (
          <div key={index} className='tickAmenity'>
            <img className='tick' src={tickImageSrc}/>
  ...
  render () {
    ...
    const more = amenitiesTwo.length < 3 ? '' : '+ more';
    ...
    return (
      <div className='hotelPageContainer'>
        ...
        <div className='infoContainer'>
          ...
          <a className='titlePackage' href={deepLink}>
          ...
          <div className='heartRatingContainer'>
            ...
            <ISearchSlider images={hotelImages} className='descriptionSlider'/>
          </div>
        </div>
      </div>
    );
