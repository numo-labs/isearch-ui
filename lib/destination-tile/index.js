...
class DestinationTile extends Component {
  ...
  render () {
    ...
    console.log(this.props.filmInView, '--------');
    const tileMedia = this.props.filmInView ? <ReactPlayer url='https://www.youtube.com/watch?v=TNCJh9WwU6w' playing width={'100%'} height={'100%'} /> : <FadeImage className='destinationImage' src={imageSrc}/>;
