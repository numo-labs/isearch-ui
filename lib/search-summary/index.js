          ...
          <div className={blueContainerStyle}>
            <div className={header}>
              <div className='weeksPaxMix'>
                <div className='weeks'>{duration}</div>
                <br/>
                <div className='paxMix'>{numberOfAdults && numberOfAdults + ' adults, ' + numberOfChildren + ' children'}</div>
              </div>
            ...
            <div className={`${stateStyle} dropDown`}>
              ...
              <DropDown width={'95%'} label={'FLYING FROM'} setValue={setDepartureAirport} options={departureOptions} />
              <DropDown width={'95%'} label={'DURATION'} setValue={setDuration} options={durationOptions} />
              <div className='dropContainer departurePaxmix'>
                <Calendar className='departureCalendar' label={'DEPARTURE'} setValue={setDepartureDate}/>
                <DropDown width={'22.5%'} label={'ADULTS'} setValue={setNumberOfAdults} options={adultOptions} />
                <DropDown width={'22.5%'} label={'KIDS'} setValue={setNumberOfChildren} options={childOptions} />
              </div>
              {childAges.map((childAge, index) => {
                return (
                  <DropDown key={index} width={'46.5%'} label={'AGE'} setValue={setChildAge} childIndex={index} options={childAgeOptions} />
                );
              })}
