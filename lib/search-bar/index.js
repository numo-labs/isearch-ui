...
function getSuggestionValue (suggestion) {
  // if (suggestion.name.length > 25) {
  //   suggestion.name = suggestion.name.slice(0, 24) + '…';
  // }
...
function renderSuggestion (suggestion) {
  if (window.innerWidth < 325) {
    if (suggestion.label.length > 10) {
      suggestion.label = suggestion.label.slice(0, 10) + '…';
    }
  } else if (window.innerWidth < 750) {
    if (suggestion.label.length > 15) {
      suggestion.label = suggestion.label.slice(0, 15) + '…';
    }
  } else {
    if (suggestion.label.length > 25) {
      suggestion.label = suggestion.label.slice(0, 25) + '…';
    }
  }
  return (
