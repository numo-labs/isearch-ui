...
class ScrollView extends Component {
  ...
  _scrollHandler () {
    ...
    console.log('loadData?', !endScroll && nodeOffsetFromWindowBottom < loadingThreshold, nodeOffsetFromWindowBottom, nodeHeight, nodeOffsetFromWindowTop, pageYScrollPosition, viewportHeight )
