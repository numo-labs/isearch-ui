...
export const SET_DURATION_TITLE = 'SET_DURATION_TITLE';
export const SET_NUMBER_OF_CHILDREN_TITLE = 'SET_NUMBER_OF_CHILDREN_TITLE';
export const SET_NUMBER_OF_ADULTS_TITLE = 'SET_NUMBER_OF_ADULTS_TITLE';
